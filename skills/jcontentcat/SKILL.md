---
name: jcontentcat
description: Manage Joomla content categories via the Joomla Web Services API. Supports listing, filtering, getting, creating, updating, and deleting categories. Only works on local development sites.
argument-hint: [site_path] [action] [options]
---

# Joomla Content Categories Manager

Manage Joomla content categories through the Joomla Web Services API on a local development site.
...
**Request:**
```
GET <baseUrl>/api/index.php/v1/content/categories[?filter[published]=1&filter[search]=foo&...]
Authorization: Bearer <token>
Accept: application/vnd.api+json
```
...
### get — Get a single content category
...
**Request:**
```
GET <baseUrl>/api/index.php/v1/content/categories/<id>
Authorization: Bearer <token>
Accept: application/vnd.api+json
```
...
### create — Create a new content category
...
**Request:**
```
POST <baseUrl>/api/index.php/v1/content/categories
Authorization: Bearer <token>
Accept: application/vnd.api+json
...
### update — Update an existing content category
...
**Request:**
```
PATCH <baseUrl>/api/index.php/v1/content/categories/<id>
Authorization: Bearer <token>
Accept: application/vnd.api+json
Content-Type: application/json
...
### delete — Delete a content category
...
**Delete request:**
```
DELETE <baseUrl>/api/index.php/v1/content/categories/<id>
Authorization: Bearer <token>
Accept: application/vnd.api+json
```
